        ...
        <SectionCard title="Account">
          <div className="profile-head">
            ...
            <div>
              ...
              <Badge tone="success">{meta.label}</Badge>
            </div>
          </div>
          <dl className="profile-dl">
            <div className="detail-row"><span className="detail-label">Department</span><span className="detail-value">{user?.dept || 'City Administration'}</span></div>
