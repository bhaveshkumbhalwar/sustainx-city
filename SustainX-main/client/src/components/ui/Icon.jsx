...
const PATHS = {
  ...
  map: (
    <>
      <path d="m20 10-6-7-8 7 8 10 6-10Z" />
      <path d="M20 10h2M14 3 6 13M9 21l-1-4-2 5-2-3-2 3" />
    </>
  ),
  chart: (
    <>
  ...
  'bar-chart': (
    <>
      <path d="M3 3v18h18" />
      <path d="M7 13v5M12 8v10M17 5v13" />
    </>
  ),
  refresh: (
    <>
  ...
  recycle: (
    <>
      <path d="M7 19H4.8a1 1 0 0 1-.86-1.5L7 12s3-5 5-8m5.5 2 1.6-1.2a1 1 0 0 1 1.6.8V19l-5-6m1 6 1.7 1.7a1 1 0 0 1-1.7.7H12" />
      <path d="m12 8 2-4H6m12 4 2-4H6" />
    </>
  ),
  'external-link': (
    <>
